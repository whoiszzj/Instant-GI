...
__global__ void project_gaussians_2d_scale_rot_backward_kernel(
    ...
    glm::mat2 scale_x_g = glm::mat2(2.f * scales2d[idx].x, 0.f, 0.f, 0.f); // x 方向的梯度
    glm::mat2 scale_y_g = glm::mat2(0.f, 0.f, 0.f, 2.f * scales2d[idx].y); // y 方向的梯度
...
//        printf("R_g %.2f %.2f %.2f %.2f\n", R_g[0][0], R_g[1][0], R_g[0][1], R_g[1][1]);
//        printf("S %.2f %.2f %.2f %.2f\n", S[0][0], S[1][0], S[0][1], S[1][1]);
//        printf("M %.2f %.2f %.2f %.2f\n", M[0][0], M[1][0], M[0][1], M[1][1]);
//        printf("theta_g %.2f %.2f %.2f %.2f\n", theta_g[0][0], theta_g[1][0], theta_g[0][1], theta_g[1][1]);
//        printf("scale_x_g %.2f %.2f %.2f %.2f\n", scale_x_g[0][0], scale_x_g[1][0], scale_x_g[0][1], scale_x_g[1][1]);
//        printf("scale_y_g %.2f %.2f %.2f %.2f\n", scale_y_g[0][0], scale_y_g[1][0], scale_y_g[0][1], scale_y_g[1][1]);
//        printf("sigma_x_g %.2f %.2f %.2f %.2f\n", sigma_x_g[0][0], sigma_x_g[1][0], sigma_x_g[0][1], sigma_x_g[1][1]);
//        printf("sigma_y_g %.2f %.2f %.2f %.2f\n", sigma_y_g[0][0], sigma_y_g[1][0], sigma_y_g[0][1], sigma_y_g[1][1]);
//    }
